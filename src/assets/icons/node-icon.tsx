...
export function NodeIcon(
  ...
  return (
    <svg viewBox="0 0 128 128" {...props}>
      ...
      <path
        fill="url(#b)"
        d="M116.897 29.76L66.841.825A8.161 8.161 0 0065.302.23L9.21 96.798a6.251 6.251 0 001.657 1.43l50.057 28.934c1.42.833 3.076 1.072 4.615.595l52.66-96.925a3.702 3.702 0 00-1.302-1.072z"
      />
      <path
        fill="url(#c)"
